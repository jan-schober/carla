    ...
    try:
        ...
        while True:
            ...
            if time_sim >= 1:
                ...
                filtered_out, _ = cva.auto_annotate_lidar(vehicles, cam, lidar_img, show_img=rgb_img,
                                                          json_path='vehicle_class_json_file.txt')

                # Save the results
                cva.save_output(rgb_img, filtered_out['bbox'], filtered_out['class'], save_patched=True,
                                out_format='json')
